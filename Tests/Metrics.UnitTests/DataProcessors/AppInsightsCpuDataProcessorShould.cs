...
{
    public class AppInsightsCpuDataProcessorShould
    {
        private const string DefaultAppId = "appId";
        private const string DefaultDeploymentId = "deploymentId";
        private const string DefaultRoleInstanceName = "roleInstanceName";
        ...
        [Theory]
        [InlineData("{\"tables\": [{\"rows\": [ [\"2020-10-16T12:00:00Z\", \"roleInstanceName\", \"deploymentId\", 42] ]}]}", 1)]
        [InlineData("{\"tables\": [{\"rows\": [ [\"2020-10-16T12:00:00Z\",\"roleInstanceName\", \"deploymentId\", 42], [\"2020-10-17T12:00:00Z\",\"roleInstanceName2\", \"deploymentId2\", 97.979797] ]}]}", 2)]
        public void Return_A_Valid_List_Of_Metrics_When_Process_Is_Called(string jsonDocument, int expectedNumberOfMetrics)
        {
            ...
            var processor = new AppInsightsCpuDataProcessor(DefaultAppId);
            ...
            metric.Name.Should().Be(nameof(AppInsightsCpuDataProcessor));
            metric.Type.Should().Be(DefaultMetricType);
            metric.InstanceId.Should().Be(DefaultRoleInstanceName);
        ...
        [InlineData("{\"tables\": [{\"rows\": [  [\"2020-10-16T12:00:00Z\", \"roleInstanceName\", 132, 42] ]}]}")]
        [InlineData("{\"tables\": [{\"rows\": [  [\"2020-10-16T12:00:00Z\", \"roleInstanceName\", \"deploymentId\", \"42\"] ]}]}")]
